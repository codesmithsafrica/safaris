...
interface Props {
  name?: string, description?: string, badge?: string,img:string
};



export default function Spot({ name, description, badge,img }: Props) {
  console.log('name', name, description,img)
  return (
    <Container maxW={'7xl'} bg={useColorModeValue('white', '#0a0a0a')}>
      <Stack
        ...
        width={'full'}
          ...
          {name ? (<Text color={'gray.500'}>
            {description ? description : `Snippy is a rich coding snippets app that lets you create your own code
